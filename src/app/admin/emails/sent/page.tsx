...
export default async function AdminEmailsSentPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Sent / history"
        description="Canonical outbox: email_outbound_events (queued / pending / skipped / failed / sent). SENT requires zoho-smtp + provider_message_id. Retry creates a new row — never rewrites a sent row into delivered fiction."
      />
