...
export const EMAIL_AUTOMATION_SPECS: EmailAutomationSpec[] = [
  ...
  catalogSpec("IDENTITY_VERIFICATION_SUBMITTED", "Identity verification submitted", "account_user"),
  catalogSpec("IDENTITY_VERIFICATION_APPROVED", "Admin approves identity verification", "account_user"),
  catalogSpec("IDENTITY_VERIFICATION_DECLINED", "Admin declines identity verification", "account_user"),
  catalogSpec("IDENTITY_VERIFICATION_INFO_REQUIRED", "Admin requests additional identity information", "account_user"),
  catalogSpec("AGREEMENT_SIGNED", "Distribution agreement signed", "account_user"),
