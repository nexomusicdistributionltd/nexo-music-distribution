...
const ADMIN_PATH_PERMISSIONS: Array<{
  ...
  { prefix: "/admin/rights", permission: "admin:operations" },
  { prefix: "/admin/fraud", permission: "admin:operations" },
  { prefix: "/admin/conflicts", permission: "admin:operations" },
  { prefix: "/admin/privacy", permission: "admin:operations" },
