...
export const CONTRIBUTOR_ROLE_OPTIONS: Array<{
  ...
  { value: "lead_vocals", label: "Lead Vocals", category: "performer" },
  { value: "vocals", label: "Vocals", category: "performer" },
  { value: "background_vocals", label: "Background Vocals", category: "performer" },
  { value: "choir", label: "Choir", category: "performer" },
  { value: "choir_member", label: "Choir Member", category: "performer" },
  { value: "chorus", label: "Chorus", category: "performer" },
  { value: "guitar", label: "Guitar", category: "performer" },
  { value: "bass_guitar", label: "Bass Guitar", category: "performer" },
  { value: "drums", label: "Drums", category: "performer" },
  { value: "keyboards", label: "Keyboards", category: "performer" },
  { value: "percussion", label: "Percussion", category: "performer" },
  { value: "instrumentalist", label: "Instrumentalist", category: "performer" },
