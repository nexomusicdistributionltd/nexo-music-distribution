  ...
  return [
    [
      item({
        ...
        description: "Live provider stream analytics scoped to this account's owned catalog.",
      }),
      item({
        href: "/analytics/meta",
        label: "Meta",
        pageKind: "analytics",
        analyticsKey: "meta",
        description: "Live Meta usage and engagement metrics returned for this account's owned catalog.",
      }),
      item({
        ...
        description: "Live YouTube UGC usage and engagement metrics returned for this account's owned catalog.",
      }),
      item({
        ...
        pageKind: "analytics",
        analyticsKey: "tiktok",
        description: "Live TikTok creations and engagement metrics returned for this account's owned catalog.",
      }),
      item({
        ...
        description: "Provider-reported suspicious, artificial, and invalid streaming signals for this account's owned catalog.",
      }),
      item({
        ...
        description: "Provider-reported Spotify Discovery Mode performance for this account's eligible owned catalog.",
      }),
      item({
        ...
        badge: "NEW",
        description: "Live Spotify listener, save, skip, playlist, and engagement metrics returned by the provider.",
      }),
      item({
        ...
        description: "Live provider download and unit data scoped to this account's owned catalog.",
      }),
    ],
  ];
}
