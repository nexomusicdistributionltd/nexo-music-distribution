-- Admin-owned branded email HTML. Ops/newsletter seeded from emails/templates/*.html.
-- Sending still goes through email_outbound_events + zoho-smtp. Never fabricate SENT.
...
comment on table public.email_templates is
  'Admin-owned branded email HTML. Not an outbox. Delivery is email_outbound_events + zoho-smtp.';
