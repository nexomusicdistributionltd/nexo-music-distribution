-- Reconcile production SECURITY DEFINER lockdown for internal helpers.
-- These functions are internal trigger/service helpers and should not be anonymous RPCs.
