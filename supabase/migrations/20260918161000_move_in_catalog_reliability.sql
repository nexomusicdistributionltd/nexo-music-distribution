-- Move In Catalog reliability hardening.
-- Preserve track-level metadata, avoid duplicate conflict inflation, and only mark
-- a migration completed when every selected item is actually imported.
