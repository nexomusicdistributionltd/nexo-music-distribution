-- Atomic identity-review decisions, verification country rules, and targeted launch ACL hardening.
-- Applied to production Supabase as migration 20260918131819 before this repository commit.
